...
from app.db import Post, create_db_and_table, create_async_engine
...
import uuid
import tempfile
from app.users import auth_beckend, current_active_user, fastapi_users
...
app.include_router(fastapi_users.get_auth_router(auth_beckend), prefix='/auth/jwt', tags=["auth"])
